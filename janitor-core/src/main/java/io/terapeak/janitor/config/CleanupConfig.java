package io.terapeak.janitor.config;
...
/**
 * Immutable value object representing a single resolved {@link Cleanup} annotation.
 * Framework adapters convert this to their own scheduler/trigger representation.
 */
public final class CleanupConfig {

    private final Class<?> entity;
    private final String   entityName;   // JPA entity name (simple class name by default)
    ...
    public static CleanupConfig from(Cleanup annotation) {
        return new Builder()
    ...
    public boolean  isSkipSoftDeleted()  { return skipSoftDeleted; }
    ...
    public static final class Builder {
        ...
        public Builder entity(Class<?> entity)               { this.entity = entity; return this; }
        ...
        public Builder skipSoftDeleted(boolean skip)         { this.skipSoftDeleted = skip; return this; }

        public CleanupConfig build() { return new CleanupConfig(this); }
    }
}
